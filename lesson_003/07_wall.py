...
for y in range(0, 600, 50):
    length_x = 100
    length_y = 50
    # TODO  Есть хитрый трюк, позволяющий убрать условие. В цикле на каждой итерации меняем shift:
    #  shift = 50 - shift. В результате shift поочерёдно будет меняться с 50 на 0 и наоборот.
    if (shift == 50):
        shift = 0
    elif (shift == 0):
        shift = 50
